        ...
        try {
            ...
            if (!empty($missingHeaders)) {
                ...
                if (!empty($nrc)) {
                    ...
                    // Check for duplicates using NRC + student name combination
                ...
                // ဒီနေရာမှာ $serialCode က "UCSMG-" ဖြစ်နေပြီး database ထဲထည့်ဖို့ အဆင်သင့်ဖြစ်နေပါပြီ

                    $serialNo = isset($data['serial_no']) && is_numeric($data['serial_no']) ? (int)$data['serial_no'] : 0;
                    ...
                    // Bind parameters - adjust the number of 's' and variables to match your actual fields
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <ul>
                    ...
                    <li>Serial Code (UCSMG-XXXXX format)</li>
            ...
            <div class="col-md-6">
                ...
                <ul>
                    <li>Dates should be in proper Excel date format</li>
                    <li>Serial Code must be in UCSMG-XXXXX format</li>
                    <li>Serial Number must be numeric</li>
