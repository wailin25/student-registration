...
<body>
    ...
    <div class="container py-4">
        ...
        <div class="form-container">
            <form id="studentForm" method="POST" enctype="multipart/form-data">
                ...
                <!-- Keep all your current form HTML exactly as you have it -->
                <!-- I'm not repeating it here to save space, but it should be included -->
                
                <!-- The form submission button at the end should be: -->
                <div class="form-header">
                    <img src="image/ucsmgy.png" alt="တက္ကသိုလ်လိုဂို" class="university-logo" align="left";>
                    <h5>ကွန်ပျူတာတက္ကသိုလ် (မကွေး)</h5>
                    <span>(</span>
                    <input type="text" name="academic_year_start" class="year-input" maxlength="4" value="၂၀၂၄" oninput="allowOnlyMyanmarDigits(this)">
                    <span>-</span>
                    <input type="text" name="academic_year_end" class="year-input" maxlength="4" value="၂၀၂၅" oninput="allowOnlyMyanmarDigits(this)">
                ...
                <div class="form-section active" id="page1">
                    <table class="main-table">
                        ...
                        <tr>
                            <td>အမျိုးသား/အမျိုးသမီး</td>
                            <td>
                                <input type="text" name="gender" pattern="M/F" maxlength="4"  placeholder="ဥပမာ - M" class="form-control">
                            </td>      
                        </tr>
                        <tr>
                            <td>တက္ကသိုလ်ဝင်ရောက်သည့်ခုနှစ်</td>
                            <td>
                                <input type="text" name="entry_year" pattern="20\d{2}" maxlength="4"  placeholder="ဥပမာ - 2024" class="form-control">
                            </td>      
                        </tr>
                    </table>
                    ...
                    <table class="main-table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="student_name_my" placeholder="မောင်ကျော်ကျော် / မလှလှ" class="form-control"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="student_name_en"  placeholder="Mg Kyaw Kyaw / Ma Hla Hla" class="form-control"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="birth_place" class="form-control" d></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="address_township" class="form-control" >
                            ...
                            <td>
                                ...
                                <input type="text" name="father_region" class="form-control">
                                <input type="text" name="father_state" class="form-control">
                            </td>
                            <td>
                                <input type="text" name="mother_township" class="form-control" >
                                <input type="text" name="mother_region" class="form-control">
                                <input type="text" name="mother_state" class="form-control">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><label class="required">မှတ်ပုံတင်အမှတ်</label></td>
                            <td><input type="text" name="nrc" class="form-control" ></td>
                            <td><input type="text" name="father_nrc" class="form-control" ></td>
                            <td><input type="text" name="mother_nrc" class="form-control" ></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="father_citizen_status" class="form-select form-select-sm">
                                    <option value="empty">တိုင်းရင်းသား/နိုင်ငံခြားသား</option>
                                    <option value="1">တိုင်းရင်းသား</option>
                                    <option value="0">နိုင်ငံခြားသား</option>
                                </select>
                            ...
                            <td>
                                <select name="mother_citizen_status" class="form-select form-select-sm">
                                    <option value="empty">တိုင်းရင်းသား/နိုင်ငံခြားသား</option>
                                    <option value="1">တိုင်းရင်းသား</option>
                                    <option value="0">နိုင်ငံခြားသား</option>
                                </select>
                        ...
                        <tr>
                            ...
                            <td>ခုံအမှတ် - </td>
                            <td><input type="text" name="entrance_exam_seat_number" class="form-control" ></td>
                            <td class="text-center" colspan="2" rowspan="3" style="padding: 8px;">
                                <div class="container-fluid">
                                    <div class="row g-2">
                                        <div class="col-md-4">
                                            <input class="form-control" type="text" name="father_address_home" placeholder="အိမ်">
                                        </div>
                                        <div class="col-md-4">
                                            <input class="form-control" type="text" name="father_address_quarter" placeholder="ရပ်ကွက်">
                                        </div>
                                        <div class="col-md-4">
                                            <input class="form-control" type="text" name="fathe_address_street" placeholder="လမ်းအမှတ်">
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="father_address_village" placeholder="ကျေးရွာ">
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="father_address_township" placeholder="မြို့နယ်" d>
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="father_phone" placeholder="09-xxxxxxxxx">
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="father_job" placeholder="အလုပ်အကိုင်" >
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>ခုနှစ် - </td>
                            <td><input type="text" name="entrance_exam_year" class="form-control" maxlength="4"></td>
                        </tr>
                        <tr>
                            <td>စာစစ်ဌာန - </td>
                            <td><input type="text" name="entrance_exam_center" class="form-control" ></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3" style="padding: 8px;">
                                <div class="container-fluid">
                                    <div class="row g-2">
                                        <div class="col-md-4">
                                            <input class="form-control" type="text" name="address_house_no" placeholder="အိမ်အမှတ်" >
                                        </div>
                                        <div class="col-md-4">
                                            <input class="form-control" type="text" name="address_street" placeholder="လမ်း" d>
                                        </div>
                                        <div class="col-md-4">
                                            <input class="form-control" type="text" name="address_quarter" placeholder="ရပ်ကွက်" >
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="address_village" placeholder="ကျေးရွာ" >
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="address_township" placeholder="မြို့နယ်" >
                                        </div>
                                        <div class="col-md-6">
                            ...
                            <td colspan="2" style="padding: 8px;">
                                <div class="container-fluid">
                                    <div class="row g-2">
                                        <div class="col-md-4">
                                            <input class="form-control" type="text" name="mother_address_house_no" placeholder="အိမ်">
                                        </div>
                                        <div class="col-md-4">
                                            <input class="form-control" type="text" name="mother_addres_quarter" placeholder="ရပ်ကွက်">
                                        </div>
                                        <div class="col-md-4">
                                            <input class="form-control" type="text" name="mother_address_street" placeholder="လမ်းအမှတ်">
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="mother_address_village" placeholder="ကျေးရွာ">
                                        </div>

                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="mother_address_township" placeholder="မြို့နယ်" >
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="mother_phone" placeholder="09-xxxxxxxxx">
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="mother_job" placeholder="အလုပ်အကိုင်" >
                                        </div>
                                    </div>
                                </div>
                            </td>
                    ...
                    <table class="exam-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="pass_serial_no<?php echo $i; ?>" class="form-control form-control-sm" style="max-width: 200px;">
                            </td>
                            <td>
                                <input type="text" name="pass_year<?php echo $i; ?>" maxlength="4" class="form-control form-control-sm" style="max-width: 200px;">
                            </td>
                            <td>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="current_township" class="form-control" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label>ဖုန်းနံပါတ်</label>
                                            <input type="text" name="current_phone" class="form-control" required>
                                        </div> 
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        // Keep all your current JavaScript exactly as you have it
        // I'm not repeating it here to save space, but it should be included
        ...
        function updateProgress(currentPage) {
            ...
            document.getElementById('progressText').textContent = 'စာမျက်နှာ ' + currentPage + '/2';
        }
